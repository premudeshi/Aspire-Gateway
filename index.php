...
$result2 = mysql_query("SELECT * FROM claims WHERE type = 'Buglary'", $link);
$num_rows2 = mysql_num_rows($result2);

$result3 = mysql_query("SELECT * FROM claims WHERE type = 'Fire' ", $link);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h1>Aspire Insurance Surveyors and Loss Assessors</h1>
...
var buglary = "<?php echo $num_rows2; ?>";
var fire = "<?php echo $num_rows3; ?>";
      function drawChart() {
