...
<select name="update" >
  ...
  <option value="Writing Report">Writing Report</option>
  <option value="Completed Soft Copy">Completed Soft Copy</option>
  <option value="Claim Completed">Claim Completed</option>
  <option value="Claim Closed">Claim Closed</option>
</select>
<button name="number" type="submit" value="<?php echo $number; ?>"><a class="w3-bar-item w3-button"><i class="fa fa-chain-broken"></i></a></button>
